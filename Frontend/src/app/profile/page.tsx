...
const ProfilePage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-400 via-white to-gray-100 px-4 pt-24 pb-6 font-sans">
      <div className="max-w-2xl mx-auto">
        {/* Back + Header */}
        <div className="mb-8">
          <Link href="/" className="inline-flex items-center gap-2 text-sm font-semibold text-gray-600 hover:text-[#0856DF] transition-colors mb-4">
            <ArrowLeft size={16} /> Back to Home
          </Link>
          <h1 className="text-4xl md:text-5xl font-black text-gray-900 tracking-tight">My Profile</h1>
          <p className="text-lg text-gray-600 font-semibold mt-1">Keep your information up to date</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
          ...
          <div className="p-8 md:p-12">
            ...
            <div className="flex flex-col items-center mb-12">
              ...
              <p className="text-center text-sm text-gray-500 font-medium">PNG, JPG, GIF or WebP &bull; Max 5MB</p>
            </div>

            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label className="block text-sm font-bold text-gray-900 mb-2 uppercase tracking-wider">Username</label>
                <div className="relative">
                  <div className="absolute left-4 top-1/2 -translate-y-1/2 text-blue-600"><User size={20} /></div>
                  <input type="text" name="username" value={form.username} onChange={handleChange}
                    ...
                    className={`w-full pl-12 pr-4 py-3 border-2 rounded-xl text-gray-900 outline-none transition-all font-semibold ${
                      errors.username ? "border-red-500 bg-red-50 focus:border-red-600 focus:ring-2 focus:ring-red-200"
              ...
              <div>
                ...
                <div className="relative">
                  <div className="absolute left-4 top-1/2 -translate-y-1/2 text-blue-600"><Phone size={20} /></div>
                  <input type="tel" name="phoneNo" value={form.phoneNo} onChange={handleChange}
                    placeholder="Enter phone number (10-15 digits)"
                    className={`w-full pl-12 pr-4 py-3 border-2 rounded-xl text-gray-900 outline-none transition-all font-semibold ${
                      errors.phoneNo ? "border-red-500 bg-red-50 focus:border-red-600 focus:ring-2 focus:ring-red-200"
                        : "border-gray-300 bg-gray-50 hover:border-gray-400 focus:border-blue-600 focus:ring-2 focus:ring-blue-200"
                    }`} />
                </div>
                {errors.phoneNo && (
              ...
              <div>
                <label className="block text-sm font-bold text-gray-900 mb-2 uppercase tracking-wider">Full Address</label>
                <div className="relative">
                  <div className="absolute left-4 top-4 text-blue-600"><MapPin size={20} /></div>
                  <textarea name="address" value={form.address} onChange={handleChange}
                    ...
                    className={`w-full pl-12 pr-4 py-3 border-2 rounded-xl text-gray-900 outline-none transition-all font-semibold resize-none ${
                      errors.address ? "border-red-500 bg-red-50 focus:border-red-600 focus:ring-2 focus:ring-red-200"
                        : "border-gray-300 bg-gray-50 hover:border-gray-400 focus:border-blue-600 focus:ring-2 focus:ring-blue-200"
                    }`} />
                  <p className="text-xs text-gray-500 mt-1 text-right font-medium">{form.address.length}/500</p>
                </div>
                {errors.address && (
                  <div className="flex items-center gap-2 mt-2 text-red-600 text-sm font-semibold">
